...
import rutaspredict from "./routes/pyimg.js"
...
app.use(express.urlencoded({extended:false}))// permite formularios
...
app.use("/python",rutaspredict)//lista. sin usar servidor python externo(childprocess)


app.use("/auth",authUser)//lista


app.use("/",pagesRutas)//front
