const enfermedades = {
  GERD: {
    nombre_es: "Enfermedad por reflujo gastroesofágico",
  ...
  "Drug Reaction": {
    nombre_es: "Reacción a medicamentos",
  ...
  AIDS: {
    nombre_es: "SIDA (Síndrome de Inmunodeficiencia Adquirida)",
  ...
  "Cervical spondylosis": {
    nombre_es: "Espondilosis cervical",
  ...
  "Paralysis (brain hemorrhage)": {
    nombre_es: "Parálisis por hemorragia cerebral",
  ...
  "Heart attack": {
    nombre_es: "Ataque cardíaco (infarto)",
  ...
  "(vertigo) Paroymsal  Positional Vertigo": {
    nombre_es: "Vértigo posicional paroxístico benigno",
